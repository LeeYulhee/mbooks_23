...
public class PostServiceTests {
    ...
    void t1() {
        ...
        postTags.forEach(postTag ->
                Assertions.assertThat(postTag.getPostKeyword().getContent()).containsAnyOf("IT", "IT 특집기사", "백엔드"));
        assertThat(post).isNotNull();
    }
    ...
    void t2() {
        ...
        postTags.forEach(postTag ->
                Assertions.assertThat(postTag.getPostKeyword().getContent()).containsAnyOf("IT", "일반기사", "프론트엔드"));
        assertThat(post).isNotNull();
    }
}
